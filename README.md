...
## Описание реализации
В программе main.cpp реализована функция writeResult(). Она создает или обновляет файл result.txt, передавая в него имена 3 самых активных контрибьюторов за последние 4 недели (спринт).
...
Запуск на Windows на примере cl:
```
cl /EHsc main.cpp /out:top3
top3
```
